# Ontic CPDF ![Status](https://img.shields.io/badge/project-maintained-brightgreen.svg)

| Branch             | Build               | Galaxy              | Release              |
| :----------------- | :------------------ | :------------------ | :------------------- |
| **master**         | [![Build](https://img.shields.io/travis/ontic/ansible-role-cpdf/master.svg)](https://travis-ci.org/ontic/ansible-role-cpdf) | [![Galaxy](https://img.shields.io/badge/galaxy-ontic.cpdf-blue.svg)](https://galaxy.ansible.com/ontic/cpdf) | [![Release](https://img.shields.io/github/release/ontic/ansible-role-cpdf.svg)](https://github.com/ontic/ansible-role-cpdf/releases) |

## Introduction

This role installs CPDF on RedHat/CentOS and Debian/Ubuntu Linux servers.
...
```
$ ansible-galaxy install ontic.cpdf
```
...
```yml
- src: git+https://github.com/ontic/ansible-role-cpdf.git
  version: master
  name: ontic.cpdf
```
